...
# Segunda división: 75% train y 25% val sobre el 80% original → 60% train, 20% val
...
def construir_modelo_mlp(embedding_sizes, num_numeric, num_classes):
    inputs = []
    embeddings = []
